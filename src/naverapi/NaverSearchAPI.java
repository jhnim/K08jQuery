...
public class NaverSearchAPI extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String clientId = "rcc4uv6dXuQjNUSKNtyw"; //애플리케이션 클라이언트 아이디값"
        String clientSecret = "4nbzJUziEj"; //애플리케이션 클라이언트 시크릿값"
        ...
        try {
        	...
        	String searchTxt = req.getParameter("keyword");//대소문자
        	startNum = Integer.parseInt(req.getParameter("startNum"));//대소문자
